...
import {IFactory} from "@buttonwood-protocol/button-wrappers/contracts/interfaces/IFactory.sol";
import {IButtonToken} from "@buttonwood-protocol/button-wrappers/contracts/interfaces/IButtonToken.sol";
...
contract ButtonTokenFactory is InstanceRegistry, IFactory {
    ...
    function create(bytes calldata args) external override returns (address) {
        ...
        address oracle;
        (underlying, name, symbol, oracle) = abi.decode(
            args,
