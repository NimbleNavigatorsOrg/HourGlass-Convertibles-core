...
import {IOracle} from "@buttonwood-protocol/button-wrappers/contracts/interfaces/IOracle.sol";
...
contract ButtonToken is IButtonToken, Initializable, OwnableUpgradeable {
    ...
    /// @inheritdoc IButtonWrapper
    function underlyingToWrapper(uint256 uAmount)
        external
        view
        override
        returns (uint256)
    ...
    /// @inheritdoc IButtonWrapper
    function wrapperToUnderlying(uint256 amount)
        external
        view
        override
        returns (uint256)
    ...
    /// @inheritdoc IButtonWrapper
    function burnTo(address to, uint256 amount)
        external
        override
        onAfterRebase
        returns (uint256)
    ...
    /// @inheritdoc IButtonWrapper
    function deposit(uint256 uAmount)
        external
        override
        onAfterRebase
        returns (uint256)
    ...
    /// @inheritdoc IButtonWrapper
    function withdraw(uint256 uAmount)
        external
        override
        onAfterRebase
        returns (uint256)
    ...
    function _amountToBits(uint256 amount, uint256 price)
        private
        pure
        returns (uint256)
    {
    ...
    function _bitsToAmount(uint256 bits, uint256 price)
        private
        pure
        returns (uint256)
    {
